...
import app.compose_credit_card.screens.AboutScreen
import app.compose_credit_card.screens.ArticlesScreen
import app.compose_credit_card.screens.SettingsScreen
...
fun MainNavigation(
    ...
    val menus = arrayOf(
        DrawerMenu(
            Icons.Filled.Face,
            LocalContext.current.getString(R.string.list_of_credit_cards),
            MainRoute.Articles.name
        ),
        DrawerMenu(
        ...
        DrawerMenu(
            Icons.Filled.Info,
            LocalContext.current.getString(R.string.about),
